...
struct ResourcesView: View {
    ...
    private let tutorSamples = [
        ResourceTutor(name: "Jennifer K.", subject: "Mathematics", rating: 4.9, hourlyRate: 45, distance: 10.0),
        ResourceTutor(name: "Michael T.", subject: "Science", rating: 4.7, hourlyRate: 50, distance: 15.0),
        ResourceTutor(name: "Sarah L.", subject: "English", rating: 4.8, hourlyRate: 40, distance: 12.0)
    ]
...
struct ResourceTutor: Identifiable {
    let id = UUID()
    let name: String
    let subject: String
    let rating: Double
...
struct ResourceTutorCard: View {
    let tutor: ResourceTutor
