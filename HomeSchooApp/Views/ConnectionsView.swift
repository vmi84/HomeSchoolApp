...
struct ConnectionsView: View {
    ...
    private let tutors = [
        ConnectionsTutor(name: "Sarah Johnson", subject: "Mathematics", specialties: ["Algebra", "Calculus"], experience: "10 years", rating: 4.9, hourlyRate: 25, isFavorite: true),
        ConnectionsTutor(name: "David Chen", subject: "Physics", specialties: ["Mechanics", "Electricity"], experience: "8 years", rating: 4.7, hourlyRate: 30, isFavorite: false),
        ConnectionsTutor(name: "Maria Garcia", subject: "Spanish", specialties: ["Conversation", "Grammar"], experience: "12 years", rating: 4.8, hourlyRate: 22, isFavorite: true),
        ConnectionsTutor(name: "Robert Wilson", subject: "Computer Science", specialties: ["Python", "Web Development"], experience: "5 years", rating: 4.6, hourlyRate: 35, isFavorite: false)
    ]
                            ...
                            VStack(alignment: .leading, spacing: 12) {
                                ...
                                VStack(spacing: 16) {
                                    ForEach(tutors) { tutor in
                                        ConnectionsTutorCard(tutor: tutor)
                                    }
                                }
                                .padding(.horizontal)
                            }
...
struct ConnectionsTutor: Identifiable {
    let id = UUID()
    let name: String
    let subject: String
...
struct ConnectionsTutorCard: View {
    let tutor: ConnectionsTutor
    @State private var isFavorite: Bool
    
    init(tutor: ConnectionsTutor) {
        self.tutor = tutor
